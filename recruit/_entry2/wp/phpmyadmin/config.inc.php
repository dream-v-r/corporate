<?php
$cfg['blowfish_secret'] = 'aM5w8LuNDVlmTOkg4F163HtI'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
$i = 0;
...
$cfg['Servers'][$i]['compress']      = FALSE;       // Use compressed protocol for the MySQL connection
                                                    // (requires PHP >= 4.3.0)
$cfg['Servers'][$i]['controlhost']   = '';          // MySQL control user settings
...
$cfg['Servers'][$i]['password']      = 'dvrecruit1234';          // MySQL password (only needed
 ...
 */
$cfg['UploadDir'] = '/virtual/cgi-data';
$cfg['SaveDir']   = '/virtual/cgi-data';
