...
# 送信先メールアドレス
$cf{mailto} = '3d-thqree@dream-v.co.jp';
...
# メール件名（初期値）
$cf{subject} = 'THQREEよりお問い合わせがありました';
...
# 返信向けメールタイトル
$cf{sub_reply} = '【3D認証システムTHQREE】お問い合わせありがとうございます';
