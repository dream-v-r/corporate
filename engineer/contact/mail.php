...
<div id="ef_mvcontents">
  <div class="inner">
    ...
    <p class="text"><img src="img/text_title_contact_comfirm.png" alt="お問い合わせに必要な情報をご入力ください。"></p>
  </div>
</div>
<section id="ef_contact_contents">
  ...
  <div class="confirm">
    <div class="inner">
      <p class="flow_input"><img src="img/fig_flow_confirm.png" alt=""></p>
      <p class="into_text">「この内容で送信する」を押していただくと、お問い合わせが完了します。<br>
...
function requireCheck($require){
	...
	foreach($require as $requireVal){
		...
		if($existsFalg != 1){
				switch($requireVal){
					case 'メールアドレス' :
					$res['errm'] .= "<p class=\"error_messe\">【".$requireVal."】の形式が正しくありません。</p>\n";
					break;
					case '氏名' :
					case 'ふりがな' :
					case 'お問い合わせ内容' :
					$res['errm'] .= "<p class=\"error_messe\">【".$requireVal."】が未入力です。</p>\n";
					break;
					default:
