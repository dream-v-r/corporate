...
日
        ...
        <tr>
          <th><p>電話番号</p>
            <span><img src="img/icon_required.png" alt="必須"></span></th>
          <td><input type="text" name="電話番号" size="40" class="w_long" value="<?php if(isset($_POST['電話番号']))echo $_POST['電話番号'] ?>" onblur="this.placeholder='ハイフンあり、半角12-13文字で入力してください。'" onfocus="this.placeholder=''"  placeholder="ハイフンあり、半角12-13文字で入力してください。"></td>
        </tr>
        <tr>
          <th><p>希望条件</p>
    ...
    <div class="terms_area">
		<div id="privacypolicy">
			...
			<dl>
				...
				<dd>代表取締役　前田 俊樹</dd>
				<dt>（３）個人情報の利用目的</dt>
				<dd>無料エントリーに登録いただいた内容を元に案件情報を提供するため</dd>
				...
				<dd>個人情報を与えることは任意です。個人情報に関する情報の一部をご提供いただけない場合は、無料エントリーに登録いただいた内容に回答できない可能性があります。</dd>
