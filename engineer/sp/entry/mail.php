...
$thanksPage = "https://www.dream-v.co.jp/engineer/sp/entry/entry_thanks.php";
...
<p>「この内容で送信する」を押していただくと、登録が完了します。</p>
</div>
...
<form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" id="test" name="test" method="POST">
<dl class="formTable">
...
<input type="hidden" name="httpReferer2" value="<?php $urlArray = explode('/', $_SERVER['REQUEST_URI']); $topDir = $urlArray[2]; echo 'https://' . $_SERVER['HTTP_HOST'] . '/' . $topDir . '/'; ?>">
<!-- input type="button" value="前画面に戻る"  class="btn_corre" id="gho_90" onClick="history.back()" -->
<button value="前画面に戻る" type="button" class="btn_corre" id="gho_90" onClick='mySubmit();'><img src="/engineer/assets/images/sp_entry/images/btn_corre.png"></button>
          </li>
        </ul>
      </div>
