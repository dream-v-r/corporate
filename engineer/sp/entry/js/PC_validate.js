...
$(function(){
	...
	$('#addskill button').on('click',function(){
		...
		$skildl.append(
		'<dt><input type="text" name="スキル名'+dtIndes+'"  class="w_long" onblur="this.placeholder=\'例　新宿 プログラマー Java\'" onfocus="this.placeholder=\'\'"  placeholder="例 : JAVA"></dt>'
        +'<dd class="year"><input type="text" name="経験年数'+dtIndes+'"  class="w_long" onblur="this.placeholder=\'例　新宿 プログラマー Java\'" onfocus="this.placeholder=\'\'"  placeholder="例 : 3年"></dd>'
		);
		return false;
	})
